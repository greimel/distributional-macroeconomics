...
md"""
`redistributive-growth.jl` | **Version 1.2** | _last updated on May 10, 2023_
"""
...
let
	Hs = Ks = range(0.01, 1, length = 101)

	title = latexstring("Contour plot of \$Y(K, H, l = 1, h = 1)\$")

	fig = Figure()

	ax, plt = contourf(fig[1,1],
		Hs, Ks, (x, y) -> F(x, y, 1., 1., (; A=A_sl, 
		η=η_sl, α=α_sl)),
		axis = (; title, xlabel = L"K", ylabel = L"H")
	)
...
The visualization of the production function was contributed by [Andrea Titton](https://github.com/NoFishLikeIan).
"""
...
# ╔═╡ 7377887e-4300-4d76-9cf3-ab6a55704724
TableOfContents()

# ╔═╡ 650d286e-5852-4f16-9560-bb396557a278
using PlutoUI: Slider

# ╔═╡ 30e81715-4076-4961-b95f-77e13279fbc8
using DataFrames

# ╔═╡ 6ad7188f-2da0-4bfd-a53c-d83eeead59f6
using CairoMakie
...
# ╔═╡ 4688a68e-dee6-41a7-a77d-fb382bc9a558
using LaTeXStrings
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "61f69a9ab9564b0b9925fe60929149961cd8df65"
