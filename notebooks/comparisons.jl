...
# ╔═╡ c6bcc6a3-b3bd-43f3-bc20-b3d3bd077a7d
using NetworkLayout, GraphMakie

# ╔═╡ e1f08f60-cf7b-4b63-93cd-f0e3be21592e
...
# ╔═╡ 21884cff-6aeb-4d0d-9a09-87e88088fdea
md"""
...
md"""
`comparisons.jl` | **Version 1.3** | *last updated: Mar 23 2022*
"""
...
This lecture is an OLG version of the model in [_Drechsel Grau & Greimel, 2022, Working Paper_](https://www.greimel.eu/static/falling-behind-paper.pdf). Here is what we will cover.
...
# ╔═╡ fac5c6f6-8483-4b80-9cb7-b49ad4416e35
debt_fig = let
...
begin df = dina_df
	...
	@chain df3 begin
		transform!(([v, :prices] => ByRow(/) => "r_$(string(v))" for v in var)...)
		@transform!(:mort2inc = :ownermort / $(inc))
	end
end

# ╔═╡ b5f6d3f4-39b4-452c-a75c-bc20f3e5ed9e
...
# ╔═╡ a331a460-15f5-4720-97f4-e6af77850bce
ineq_fig = let
	fg = @chain df3 begin
		@groupby(:three_groups)
		@transform(:normalized = @c normalize($("r_" * string(inc)), :year => 1980))
		data(_) * visual(Lines) * mapping(:year, :normalized, color = :three_groups => "")
