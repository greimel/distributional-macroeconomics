...
md"""
`mobility_aiyagari.jl` | **Version 1.0** | *last updated: May 18 2022* | *created by [Daniel Schmidt](https://github.com/danieljschmidt)*
"""
...
md"""
### Exercise 1: No borrowing constraint

👉 Assume for a moment that there is no borrowing constraint in the model. What condition needs to be satisfied so that agents will accept the job with the higher salary?
"""
...
In the following, we consider an Aiyagari-type model with a borrowing constraint $k\ge 0$ and explore how the moving cost interacts with the borrowing constraint.
...
md"""
### Exercise 5: Discuss results

👉 What is interesting about the policy functions and the stationary distribution plotted above? Please write down your observations in the cell below.
"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "8f4914a1b4e220d90e577f410482a73ec0a50d5b"
