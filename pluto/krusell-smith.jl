...
# ╔═╡ fb402e97-95af-4649-96a0-7417fe811fee
using PlutoUI

# ╔═╡ 85a76b6a-ce0a-11eb-1096-092fb836d16c
md"""
# A Model of the Wealth Distribution
"""

# ╔═╡ 4cf1d02e-0717-4a35-be30-a0b4832a6370
...
```math
Z = \int z Γ(d z, d a) = \int c(z, a) Γ(d z, d a), \qquad \int a Γ(d z, d a) = 0. 
```
...
# ╔═╡ 51cecaf3-91d0-47ea-b5d6-d4c0dfd3c09d
...
# ╔═╡ 8dc6fa4b-0365-4a06-a51f-8115e677c6b9
exo = ExogenousStateSpace([z_MC])

# ╔═╡ 1cd79fed-55c0-43b2-960c-11d2ac8be641
md"""
## Huggett Setup
"""

# ╔═╡ 27e241bf-b44f-4507-8d02-70ba52d29402
u(c) = c > 0 ? log(c) : 10000 * c - 10000 * one(c)

# ╔═╡ 72f86765-8da4-473c-8cbc-d17ccf225562
...
# ╔═╡ c99fac0c-215d-495b-9ffb-8648700e2c4f
let
	fig = Figure()
...
# ╔═╡ c209aa1d-78a9-42a1-9704-ee16f66385a9
exo_ss(gross_inc) = ExogenousStateSpace([markovchain(gross_inc)])

# ╔═╡ e9407ec0-c047-4cb2-a249-67bf7a7e271b
md"""
## Other Stuff
"""

# ╔═╡ 5faf2847-fc05-48da-8f55-6f1929337066
TableOfContents()
