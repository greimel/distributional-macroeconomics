...
begin
	...
	Base.values(s::State) = getfield(s, :values)
	indices(s::State) = getfield(s, :indices)
	Base.getproperty(s::State, key::Symbol) = getproperty(values(s), key)
	indices(s::State, key) = getproperty(indices(s), key)
	index(s::State) = getfield(s, :index)
end
...
# ╔═╡ d4b80a51-e7aa-442b-84ec-f41659e8a7ba
...
# ╔═╡ 26ef9ddb-25c2-45b5-bb7c-3a506d511a88
dp.T.(grid, action.(Ref(sol), grid))[1]
...
deps = ["ArrayInterface"]
git-tree-sha1 = "028b97126da0988991575282ee99ff49cb47973b"
...
git-tree-sha1 = "9d1fe2c5acbfd4cc8556f1beb68b555115cf493c"
