...
begin
	using Pkg
	Pkg.activate(joinpath(@__DIR__(), "..", "pluto-deployment-environment"))
end
...
book_model = JSON3.read(read(joinpath(PROJECT_ROOT, "generate", "book_model.json"), String), Vector{Chapter})
